...
";
   ...
   <div class=\"box\" style=\"border-top-color: skyblue;\">
                ...
                <div class=\"box-body\">  
     <form action=\"#\" method=\"post\" style=\"display: inline;margin: 20px 20px 20px 20px;\">
        ...
        <input class=\"btn btn-primary\" type=\"submit\" value=\"Information Personnelle\"/>
         ...
         <form style=\"display: inline;margin: 20px 20px 20px 20px;\" action=\"";
        // line 18
        ...
        echo "\" method=\"post\" style=\"display: inline;margin: 20px 20px 20px 20px;\">
        <input type=\"hidden\" name=\"id\" value=\"";
        // line 26
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["ens"]) ? $context["ens"] : $this->getContext($context, "ens")), "id", array()), "html", null, true);
        echo "\"/>
...
";
    ...
    {
        return array (  105 => 33,  97 => 28,  93 => 27,  89 => 26,  85 => 25,  78 => 21,  74 => 20,  70 => 19,  66 => 18,  59 => 14,  55 => 13,  51 => 12,  44 => 7,  41 => 6,  32 => 4,  29 => 3,  11 => 2,);
    }
}
