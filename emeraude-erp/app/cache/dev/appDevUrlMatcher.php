...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/planning')) {
            ...
            if (0 === strpos($pathinfo, '/planning/supp-e')) {
                ...
                // e_plan_planning_suppec_enseignant
                if ($pathinfo === '/planning/supp-ec-enseignant') {
                    return array (  '_controller' => 'EPlan\\PlanningBundle\\Controller\\EnseignantController::suppEcEnseignantAction',  '_route' => 'e_plan_planning_suppec_enseignant',);
                }
            ...
            if (0 === strpos($pathinfo, '/planning/enreg')) {
                // e_plan_planning_enregitrer_UE
                if ($pathinfo === '/planning/enregUE') {
                    return array (  '_controller' => 'EPlan\\PlanningBundle\\Controller\\DivisionController::enregistrerUEAction',  '_route' => 'e_plan_planning_enregitrer_UE',);
                }

                // e_plan_planning_enregitrer_Ec
                if ($pathinfo === '/planning/enregEc') {
