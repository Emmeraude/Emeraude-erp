 ...
 */
class ParcourtType extends \EPlan\PlanningBundle\Entity\ParcourtType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\ParcourtType' . "\0" . 'id', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\ParcourtType' . "\0" . 'nom', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\ParcourtType' . "\0" . 'code', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\ParcourtType' . "\0" . 'mention', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\ParcourtType' . "\0" . 'etapes');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ParcourtType $proxy) {
    ...
    public function getNombreEtudiants()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNombreEtudiants', array());

        return parent::getNombreEtudiants();
    }
