 ...
 */
class UE extends \EPlan\PlanningBundle\Entity\UE implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\UE' . "\0" . 'id', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\UE' . "\0" . 'nom', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\UE' . "\0" . 'code', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\UE' . "\0" . 'ecs');
        }
