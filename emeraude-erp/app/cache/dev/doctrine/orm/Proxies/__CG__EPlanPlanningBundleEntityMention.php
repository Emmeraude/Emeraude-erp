 ...
 */
class Mention extends \EPlan\PlanningBundle\Entity\Mention implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\Mention' . "\0" . 'id', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\Mention' . "\0" . 'nom', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\Mention' . "\0" . 'departement', '' . "\0" . 'EPlan\\PlanningBundle\\Entity\\Mention' . "\0" . 'parcourtTypes');
        }
    ...
    public function addParcourtType(\EPlan\PlanningBundle\Entity\ParcourtType $parcourtTypes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addParcourtType', array($parcourtTypes));

        return parent::addParcourtType($parcourtTypes);
    }
    ...
    public function removeParcourtType(\EPlan\PlanningBundle\Entity\ParcourtType $parcourtTypes)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeParcourtType', array($parcourtTypes));

        return parent::removeParcourtType($parcourtTypes);
    }
